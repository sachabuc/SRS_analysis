...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\CHIRP\260527\13-05-52_vaterite_7ps'
...
wavelengths =[926.6,927.1,927.6,928,928.5,929,927.8,927.4,926.8,926.2,925.8];
...
%-------- Plot final --------
figure;
plot(wavenumber_sorted, sp_sorted,'-x','LineWidth',1.5);
xlabel('wavenumber (cm-1)');
ylabel('Intensity (a.u.)');
title(['Spectrum (Channel ' num2str(n_ch) ', BG corrected)']);
grid on;
%%
superpose_spectre_Vaterite(wavenumber_sorted,sp_sorted,4)
%%superpose_spectre_Calcite(wavenumber_sorted,sp_sorted,4);
