...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\CHIRP\260703\13-02-22_coral_2ps';
...
wavelengths =[926.9,927.2,927.5,927.8,928.3,928.6,929.1,929.4,929.6,930,930.4,930.8,931.1,931.5,931.9,932.9,926.7,926.4,926,925.6,924.9];
...
title('ACC (I4)');
    ...
    subplot(2,3,5);
imagesc(I4-I3); caxis([-10 10]); colorbar;
title('I4-I3)');

subplot(2,3,6);
imagesc(I2-I3); caxis([-10 10]); colorbar;
title('I2-I3');  
...
if ROI_known == true 
    ...
    imagesc(I4-I2); caxis([-100 0]); colorbar;
    title('I4-I2');
    axis image;
    colormap parula;
    colorbar;
    
    % -------- Coordonnées des ROI (à modifier) --------
    x_bg=4.068975e+01; y_bg=5.070873e+01; width_bg=3.870968e+00; height_bg=4.554080e+00;
    x_sig=4.478843e+01; y_sig=1.752372e+00; width_sig=6.011385e+01; height_sig=2.823529e+01;
    ...
    % imagesc(sum(I_raw,3));
    imagesc(I3); caxis([Imin Imax]); colorbar;
    title('Calcite (I3)');    % imagesc(I_raw(:,:,1));
    axis image;
    colormap parula;
    colorbar;
...
superpose_spectre_ACC(wavenumber_sorted,sp_sorted,10)
