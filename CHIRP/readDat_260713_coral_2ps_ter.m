...
wavelengths =[928.3,928.7,929.1,929.5,929.9,930.3,931,928.1,927.8,927.5,927.2,926.7,926.3,925.8];
...
% [I_corr,SNR,sigma_spec] = remove_planar_background(imgs,5:15,5:15,true,1);
