...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\CHIRP\260710\14-15-12_coral_2ps_bis';
...
wavelengths =[928.3,928.6,929.2,928,927.6,927.2,926.9];
...
title('ACC (I4)');
    ...
    subplot(2,3,5);
imagesc(I4-I3); caxis([-5 3]); colorbar;
title('I4-I3)');

subplot(2,3,6);
imagesc(I2-I3); caxis([-5 3]); colorbar;
title('I2-I3');  
