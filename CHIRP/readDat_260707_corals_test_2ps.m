...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\CHIRP\260707\15-11-10_corals_2ps_test';
...
wavelengths =[928.6,928.1,927.6,927.2,926.7,926.4,926,925.6,925,929,929.4,929.7,930.1,930.5,931,931.9];
...
title('ACC (I4)');
    ...
    subplot(2,3,5);
imagesc(I4-I3); caxis([-15 10]); colorbar;
title('I4-I3)');

subplot(2,3,6);
imagesc(I2-I3); caxis([-15 10]); colorbar;
title('I2-I3');  
