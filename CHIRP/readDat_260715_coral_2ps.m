...
wavelengths =[927.2,927.5,927.7,928.1,928.5,929.1,929.6,930.2,931.1,926.7,926.3,925.8];
...
if ROI_known == true 
    ...
    x_bg=9.195364e+00; y_bg=2.761921e+01; width_bg=5.165563e+00; height_bg=4.993377e+00;
    x_sig1=1.236802e+01; y_sig1=1.852987e+01; width_sig1=6.061383e+00; height_sig1=1.918556e+00;
    x_sig2=1.780464e+01; y_sig2=5.275828e+01; width_sig2=4.132450e+00; height_sig2=4.476821e+00;
...
[phase_map, A_maps, ratio_maps] = ...
    ...
    false, ...             % Aragonite
    true, ...              % Calcite
    50, ...                 % seuil bruit = 3 sigma
    0.2, ...              % seuil ACC/Calcite
    true);                 % affichage
