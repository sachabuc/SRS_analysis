...
% main_dir = 'C:\Users\sacha\OneDrive\Documents\FRESNEL\CHIRP\260708\16-25-59_ACC_Cal_7ps'
...
wavelengths =[928.6,929.1,929.5,929.8,930.2,930.6,931.1,928,927.6,927.2,926.8,926.4,926,925.5,928.3];
...
ref_spectra_shifted = extract_shifted_reference_spectra( ...
          ref_spectra_2ps, I_corr, wavenumber, phase_model_2ps, ...
          shift_row, shift_col, tau_fwhm, pixel_fit, ...
          false, display_figures);
...
for i = 1:numel(ref_spectra_shifted)

    rs = ref_spectra_shifted(i);
...
saveDataOrImage(ref_spectra_shifted, sub_dir_save, 'Name','ref_spectra');
