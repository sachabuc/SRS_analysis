...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\CHIRP\260708\14-10-33_ACC';

sub_dir  = '';
sub_dir_save = [main_dir '/extracted_data/' sub_dir];

title_fig = 'ACC no chirp';

wavelengths =[928.5,928.8,929.2,929.6,929.9,930.3,930.8,931.2,931.5,931.8,932.1,932.6,932.9,928.3,927.8,927.5,927.1,926.6,926.1,925.6,925,924.5,923.9];
...
figure(99); imagesc(sum(I_raw,3)); colorbar;
...
% 
%     subplot(2,3,5);
% imagesc(I4-I3); caxis([-10 20]); colorbar;
% title('I4-I3)');
% 
% subplot(2,3,6);
% imagesc(I4-I1); caxis([-10 20]); colorbar;
% title('I4-I2');  
% 
...
x_bg=9.761575e+01; y_bg=1.003482e+02; width_bg=6.603416e+00; height_bg=5.920304e+00;
x_sig=7.146317e+01; y_sig=2.846034e+01; width_sig=2.973300e+00; height_sig=3.039959e+00;
...
superpose_spectre_ACC(wavenumber_sorted,sp_sorted,10.8)
