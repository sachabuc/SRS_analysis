...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\CHIRP\260626\15-16-36_ACC_Cal_2ps';

sub_dir  = '';
sub_dir_save = [main_dir '/extracted_data/' sub_dir];

title_fig = 'coral ACC no chirp';

wavelengths =[929.2,928.8,928.5,928.2,927.7,927.4,926.9,926.6,926.2,925.7,925,924.1,929.1,929.5,929.8,930.2,930.5,931,931.8,932.9];
...
superpose_spectre_Ara_MHC(wavenumber_sorted,sp_sorted,10.8)
