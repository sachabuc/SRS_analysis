...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\CHIRP\260529\17-15-15_Cal_7ps'
...
wavelengths =[927.2,927.8,926.5,926.9,927.5,926.7];
...
% s = load('C:\Users\sacha.bucourt\Documents\Data lab\CHIRP\260522\16-01-52_calcite_2ps\extracted_data\spectrum_calcite geologique no chirp.mat');
% 
% superpose_spectre_Calcite(wavenumber_sorted,sp_sorted, 7.4, s.wavenumber_sorted, s.sp_sorted)
...
%% Save fit results
fit_results = struct();
fit_results.title     = title_fig;
fit_results.wn        = wn;
fit_results.sp        = sp;
fit_results.n_peaks   = n_peaks;
fit_results.lambda0   = lambda0;
fit_results.FWHM_fit  = FWHM_fit;
fit_results.amplitude = amplitude;
fit_results.offset    = offset;

save([sub_dir_save '/fit_' title_fig '.mat'], 'fit_results');
disp(['Fit sauvegardé : ' sub_dir_save '/fit_' title_fig '.mat']);
%% Save mat files 
cd(main_dir);
