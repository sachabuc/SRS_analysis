function params = parameters_cocco_260116_c4()

    % Chemin des dossiers
    this_dir     = fileparts(mfilename('fullpath'));
    project_root = fileparts(fileparts(this_dir));

    day_folder_data = '260116';
    folder_data = '14-17-49_cell4';

    params.main_dir = fullfile(project_root, 'data', 'raw', 'data_cocco1', ...
    ...
    params.n_depart = 3;
    params.n_ch = 1;
    params.wavelengths = [926.9, 930.6, 927.8, 928.7, 929.2];
