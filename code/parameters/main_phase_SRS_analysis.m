...
saveDataOrImage(phase_model, params.results_dir, 'Name', 'phase_model','Format','mat');
saveDataOrImage(pixel_fit, params.results_dir, 'Name', 'pixel_fit','Format','mat');
saveDataOrImage(ref_spectra, params.results_dir, 'Name', 'ref_spectra','Format','mat');