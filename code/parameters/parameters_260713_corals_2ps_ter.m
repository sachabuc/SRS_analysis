function params = parameters_260713_corals_2ps_ter()
    ...
    params.n_depart = 3;
    params.n_ch = 1;
    params.wavelengths = [928.3,928.7,929.1,929.5,929.9,930.3,931,928.1,...
        927.8,927.5,927.2,926.7,926.3,925.8];
    params.wavelengths_7ps = [927.2,927.6,928.1,928.3,928.7,929.1,929.5,...
