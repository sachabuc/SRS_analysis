function params = parameters_260527_14_34_59_vaterite_2ps()
    ...
    params.n_depart = 3;
    params.n_ch = 1;
    params.wavelengths = [926.7,927.1,927.5,927.9,928.5,928.8,929.3,929.6,930,926.9,926.1,926.5,925.7,925,924.4];
    params.wavelengths_7ps = [];
    params.pompe = 1031;
    ...
    params.priority_phases =       [false false true false false false];
    params.priority_min_fraction = [0 0 1 0 0 0];
