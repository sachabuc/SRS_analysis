...
%main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\spectres\geo_aragonite_nochirp4';
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\spectres\banque spectres SRS\geo_calcite_nochirp2\15-53-22_calcite_nochirp_2'
% main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\spectres\synt_acc_nochirp'
% main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\spectres\campagne cocco\260112a'
sub_dir  = '';
...
%calcite nochirp2
 wavenumber = [1146.90156, 1139.846494, 1133.974279, 1126.936014, 1122.248915, ...
                   1116.395746, 1110.548904, 1104.708379, 1098.874162, 1093.046242, ...
                   1087.224609, 1080.246933, 1075.600162, 1069.797328, 1066.318627, ...
                   1059.367962, 1052.426265, 1047.803441, 1042.030498, 1037.416607, 1030.503196];

%aragonite nochirp4
% wavenumber = [1145.725078, 1133.974279, 1121.077775, 1110.548904, 1105.875979, 1098.874162, 1093.046242, 1087.224609, 1083.734642, 1081.409252, 1075.600162, 1069.797328, 1062.842172, 1053.582592, 1039.723057, 1030.503196];

%ACC nochirp
% wavenumber = [2065.828221, 1995.644526, 1927.64507, 1793.990966, 1663.374457, 1535.693149, 1472.92245, 1413.318889, 1348.241021, 1289.956798, 1229.894394, 1204.863502, 1181.130911, 1157.501394, 1133.974279, 1110.548904, 1098.874162, 1087.224609, 1075.600162, 1065.159559, 1053.582592, 1040.876654, 1029.351827, 1015.554638, 1008.669342, 996.0692513, 972.0966842, 949.365356, 925.6014443, 903.0675384, 881.7486749, 824.9459658, 770.9422814, 717.4899421, 663.5063591, 609.0164434, 556.1483493, 503.8197256, 453.0531503, 398.707998];

%cocco 260112a
% wavenumber = [1089.305203, 1078.835301, 1073.027463, 1067.22588, 1059.114151, 1051.014633, 1082.32301, 1099.795461, 1120.837284, 1167.891679, 1173.802263, 1159.627645, 698.742478, 698.742478, 802.528142, 1084.649404];
...
% --- Middle Z plane ---
z_mid = round(size(imgs_Z,3)/2);
img_ref = sum(imgs_Z, 3);
...
% --- Spectrum over Z ---
nZ = size(imgs_Z,3);
spectrum_signal = zeros(nZ,1);
spectrum_bg     = zeros(nZ,1);
...
spectrum_corr = spectrum_signal - spectrum_bg;
wn = (1:nZ)';   % ou z_pos si tu veux
sp = spectrum_corr;

figure;
plot(wn, sp, 'k-', 'LineWidth', 1.5);
xlabel('Z index');
ylabel('Intensity (a.u.)');
title('Spectrum from Z stack');
grid on;
