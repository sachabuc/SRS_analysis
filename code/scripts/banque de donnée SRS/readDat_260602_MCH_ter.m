...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\spectres\banque spectres SRS\260602\14-33-35_MHC0206_ter'
...
wavelengths =[928.4,928,927.6,927.4,926.9,928.8,929.3,929.8,930.4] ;

pompe = 1031; % modifié pour correspondre avec Raman spontané 
...
% figure;
% imagesc(sum(I_raw,3)-mean(spectrum_bg));
% xlabel('X ');
% ylabel('Y');
% title(['Sum images BG corrected)']);
