...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\spectres\banque spectres SRS\synt_acc_nochirp'

sub_dir  = '';
sub_dir_save = [main_dir '/extracted_data/' sub_dir];

title_fig = 'aragonite geologique no chirp';

wavelengths = [849.9, 855.0, 860.0, 870.0, 880.0, 890.0, 895.0, 899.8, 905.1, 909.9, 914.9, 917.0, 919.0, 921.0, 923.0, 925.0, 926.0, 927.0, 928.0, 928.9, 929.9, 931.0, 932.0, 933.2, 933.8, 934.9, 937.0, 939.0, 941.1, 943.1, 945.0, 950.1, 955.0, 959.9, 964.9, 970.0, 975.0, 980.0, 984.9, 990.2
];
