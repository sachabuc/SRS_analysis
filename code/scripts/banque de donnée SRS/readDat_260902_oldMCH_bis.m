...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\spectres\banque spectres SRS\260902\15-34-10_oldMHC0602_bis';

sub_dir  = '';
sub_dir_save = [main_dir '/extracted_data/' sub_dir];

title_fig = 'MHC synthétique';

wavelengths=[928.8,928.5,928.3,927.9,927.6,926.9,929.4,929.8,930.3];
