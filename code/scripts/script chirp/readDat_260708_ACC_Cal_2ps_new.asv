...
wavelengths  = [927,927.5,928,928.3,928.6,929.1,929.4,929.6,929.8,930.4, ...
                930.8,931.1,931.5,931.8,932.5,932.9,926.4,926,925.6, ...
                925.2,924.8,924,923];  % nm, ordre d'acquisition (pas trie)
...
fwhm_mesure = 14.5; %fwhm mesuré de la calcite
