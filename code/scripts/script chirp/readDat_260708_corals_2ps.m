...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\CHIRP\260708\11-02-23_coral_2ps';
...
wavelengths =[927.2,927.6,928.5,928.8,929.2,929.5];
...
subplot(2,3,6);
imagesc(I3-I1); caxis([-10 10]); colorbar;
title('I1-I3');  
...
if ROI_known == true 
    ...
    imagesc(I4-I2); caxis([-10 10]); colorbar;
    title('I4-I2');
    axis image;
    colormap parula;
    colorbar;
