...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\CHIRP\260527\14-34-59_vaterite_2ps'
...
wavelengths =[926.7,927.1,927.5,927.9,928.5,928.8,929.3,929.6,930,926.9,926.1,926.5,925.7,925,924.4];
...
superpose_spectre_Vaterite(wavenumber_sorted,sp_sorted,10);
% superpose_spectre_Calcite(wavenumber_sorted,sp_sorted,10);
