...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\CHIRP\260703\13-49-00_coral_7ps';
...
wavelengths =[926.9,927.2,927.5,928.4,928.6,928.9,929.2,929.6,929.9,930.2,930.8,931,931.3,926.6,926.1,925];
...
subplot(2,3,6);
imagesc(I4./I3); caxis([0 1]); colorbar;
title('I4./I3');  
