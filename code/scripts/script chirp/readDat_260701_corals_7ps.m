...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\CHIRP\260702\16-16-33_coral_7ps_bis'

sub_dir  = '';
sub_dir_save = [main_dir '/extracted_data/' sub_dir];

title_fig = 'calcite geologique - no chirp 2 ps';

wavelengths =[927.1,927.4,928.5,928.2,928.8,929.1,929.4,929.6,930,926.8,926.4,926,927.8,928.3,925];
...
subplot(2,3,6);
imagesc(I3-I1); caxis([0 10]); colorbar;
title('I3-I1');  
...
if ROI_known == true 
    ...
    x_bg=2.839374e+01; y_bg=2.611670e+01; width_bg=4.781784e+00; height_bg=6.375712e+00;
    x_sig=4.752087e+01; y_sig=1.700854e+01; width_sig=5.305503e+01; height_sig=1.958254e+01;
