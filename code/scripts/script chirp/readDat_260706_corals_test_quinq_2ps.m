...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\CHIRP\260706\16-34-57_corals_2ps_test_quinq';
...
wavelengths =[929.1,928.7,928.4,928.1,927.4,926.9,926.5,926,925.5,925,924.5,924,923,927.8,929.7,930.2,931.1];
...
title('ACC (I4)');
    ...
    subplot(2,3,5);
imagesc(I4-I3); caxis([-50 10]); colorbar;
title('I4-I3)');

subplot(2,3,6);
imagesc(I3-I1); caxis([-15 10]); colorbar;
title('I1-I3');  
