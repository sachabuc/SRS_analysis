...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\CHIRP\260708\14-55-09_ACC_Cal - copie'
...
wavelengths =[927,927.5,928,928.3,928.6,929.1,929.4,929.6,929.8,930.4,930.8,931.1,931.5,931.8,932.5,932.9,926.4,926,925.6,925.2,924.8,924,923];
...
% --- Clean data ---
valid = isfinite(sp2_sorted) & isfinite(wavenumber_sorted(:));
...
for k = 1:n_peaks
    ...
    annotation('textbox', [0.35 ypos 0.25 0.050], ...
        'String', txt, ...
        'FitBoxToText','on', ...
        'BackgroundColor','w', ...
        'EdgeColor','k', ...
