...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\CHIRP\260701\15-13-32_coral_2ps';
...
wavelengths =[927.1,927.6,928,928.5,928.8,929.3,929.6,929.9,930.4,931.1,926.7,926.3,925.8,925.4,924.9,924.5,924.1,923.5];
...
title('ACC (I4)');
    ...
    subplot(2,3,5);
imagesc(I4-I3); caxis([-20 20]); colorbar;
title('I4-I3)');

subplot(2,3,6);
imagesc(I2-I3); caxis([-20 20]); colorbar;
title('I2-I3');  
