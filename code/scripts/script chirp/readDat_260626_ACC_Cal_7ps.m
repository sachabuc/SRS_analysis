...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\CHIRP\260626\16-16-16_ACC_Cal_7ps'

sub_dir  = '';
sub_dir_save = [main_dir '/extracted_data/' sub_dir];

title_fig = 'coral ACC - chirp 7 ps';

wavelengths =[929.1,928.7,928.5,928.1,927.7,927.4,926.7,926.4,926,929.5,930,927.1];
...
superpose_spectre_Ara_MHC(wavenumber_sorted,sp_sorted,5.8);
