...
% main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\CHIRP\260715\15-04-42_coral_7ps'
main_dir='C:\Users\sacha\OneDrive\Documents\FRESNEL\CHIRP\260715\15-04-42_coral_7ps'
sub_dir  = '';
sub_dir_save = [main_dir '/extracted_data/' sub_dir];

title_fig = 'ACC + cal - no chirp : 2 ps';

wavelengths =[927.8,927.2,928.1,928.5,929.1,929.6,930.3,931,927.5,926.8,926.4,925.8];
...
x_bg=5.803605e+00; y_bg=1.937097e+01; width_bg=8.140417e+00; height_bg=8.387097e+00;
x_sig1=3.614516e+01; y_sig1=2.381120e+01; width_sig1=6.660342e+00; height_sig1=6.166983e+00;
x_sig2=8.662247e+01; y_sig2=1.166168e+02; width_sig2=2.702815e+00; height_sig2=2.703855e+00;
...
[phase_map, A_maps, ratio_maps] = ...
    ...
    true, ...             % Aragonite
    false, ...              % Calcite
    20, ...                 % seuil bruit = 3 sigma
    0.3, ...              % seuil ACC/Calcite
    true);                 % affichage
