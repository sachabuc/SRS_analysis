...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\spectres\campagne cocco\260112c'
sub_dir  = '';
...
wavelengths = [927.4, 926.7,926.4, 925.8, 928.1, 928.6, 929.5, 930.5, 920.8, 919.9, 921.6]; 
% 
...
%Contrast
    ...
    I4 = squeeze(I_corr(n4,:,:)); % polyphosphate 1
    ...
    subplot(3,3,5);
    imagesc(I3-I1); caxis([-0.5 3]); colorbar;
    title('(I3-I1)');
    ...
    subplot(3,3,9);
    imagesc(I4-I1); caxis([-0.5 3]); colorbar;
    title('I4-I1');
