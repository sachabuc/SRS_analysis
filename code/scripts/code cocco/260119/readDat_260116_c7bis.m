...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\spectres\campagne cocco\260119\09-20-42_cell7bis';
...
%260114a Z0
wavelengths=[927, 930.4, 928, 928.6, 929.3]; 
...
if contrast == true
    ...
    I4 = I_corr(:,:,n4); % ACChira
    I5 = I_corr(:,:,n5); % ACC inf
    C31=(I3-I1)./(I1+I3);
    C312=(I3-I1)./(I1+I3-2*I2);
    C34=(I3-I4)./(I4+I3);
    C342=(I3-I4)./(I4+I3-2*I2);
    C352=(I3-I5)./(I5+I3-2*I2);
    C42=(I4-I2)./(I2+I4);
    C41=(I4-I1)./(I1+I4);
    C45=(I4-I5)./(I5+I4);
    C412=(I4-I1)./(I1+I4-2*I2);
    C4=(I4-I2);
    C5=(I5-I2);
    ...
    % Contraste binné
    C34_bin = (I3_bin - I4_bin) ./ (I3_bin + I4_bin - 2*I2_bin);
    C312_bin = (I3_bin - I1_bin) ./ (I3_bin + I1_bin - 2*I2_bin);
    % C45_bin = (I4_bin - I5_bin) ./ (I4_bin + I5_bin);
    
    figure(102); clf;
    
    subplot(3,3,1);
    imagesc(I1); caxis([-1 130]); colorbar;
    title('calcite (I1)');
    
    subplot(3,3,4);
    imagesc(I2); caxis([-1 30]); colorbar;
    title('fluo (I2) ');
    
    subplot(3,3,2);
    imagesc(I3); caxis([-1 30]); colorbar;
    title('ACC H2O (I3)');

    subplot(3,3,3);
    imagesc(I4); caxis([-1 30]); colorbar;
    title('ACChira (I4) ');

    subplot(3,3,5);
    imagesc(C352); caxis([-0.5 1]); colorbar;
    title('(I3-I5)./(I3+I5-2*I2)');
    % subplot(3,3,6);
    % imagesc(C412); caxis([-1 2]); colorbar;
    % title('(I4-I1)./(I1+I4-2*I2)');    

    subplot(3,3,6);
    imagesc(C45); caxis([-0.5 1]); colorbar;
    title('(I4-I5)./(I5+I4)');
    
    subplot(3,3,8);
    imagesc(C34); caxis([-1 1]); colorbar;
    title('(I3-I4)./(I4+I3)');

    subplot(3,3,9);
    imagesc(C34_bin); caxis([-1 1]); colorbar;
    title('(I3-I4)./(I4+I3-2*I2) - binné');

    subplot(3,3,7);
    imagesc(I5); caxis([-1 30]); colorbar;
    title('ACC inf (I5)');
 
    % subplot(3,3,8);
    % imagesc(C31); caxis([-1 1]); colorbar;
    % title('(I3-I1)./(I3+I1)');
    % 
    % subplot(3,3,9);
    % imagesc(C312_bin); caxis([-1 1]); colorbar;
    % title('(I3-I1)./(I3+I1) - bin');
    ...
    % subplot(3,2,4);
    % imagesc((I2-I1)./(I2+I1)); caxis([-0.5 0.5]); colorbar;
    % title('(I2-I1)./(I2+I1)');
    ...
    % axis image;
    % colorbar;
    % title('(I2-I3)./(I2+I3) binné 2x2');

    % subplot(2,2,4);
    % imagesc((I2-I3)./(I3+I2)); caxis([-0.5 0.5]); colorbar;
    % title('(I2-I3)./(I2+I3)');    
