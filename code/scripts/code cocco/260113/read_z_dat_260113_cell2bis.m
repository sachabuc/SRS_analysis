...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\spectres\campagne cocco\260113\cell2'
sub_dir  = '';
...
wavelengths = [927.2,928.6,929.2,925.8];
...
%Contrast
    ...
    subplot(3,2,2);
    imagesc(I2); caxis([0 1]); colorbar;
    title('ACChira inf (I2)');
    ...
    subplot(3,2,3);
    imagesc(I3); caxis([0 1]); colorbar;
    title('inf ACC (I3)');

    subplot(3,2,4);
    imagesc((I2-I1)./(I1+I2)); caxis([-1 1]); colorbar;
    title('(I2-I1)./(I2+I1)');
