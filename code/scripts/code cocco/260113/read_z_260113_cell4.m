...
% [927.1,920.9,920,923.6,961.5,952.1]
%Contrast
    n1 = 1; 
    n2 = 2;
    n3 = 4;
    ...
    I2 = squeeze(I_corr(n2,:,:)); % poly 1 
    I3 = squeeze(I_corr(n3,:,:)); % poly 1 inf
    ...
    [mask_calcite, mask_acc] = detect_calcite_acc_mistral(squeeze(image_Zi),wavenumber,3);
