...
%Contrast
    ...
    subplot(3,3,6);
    imagesc(I3-I2); caxis([-1 1]); colorbar;
    title('I3-I2');
    hold on;
    contour(I1, 3, 'w', 'LineWidth', 1);
    %     % Superposition des pixels avec R² > seuil_R2
    ...
    subplot(3,3,8);
    imagesc(I3-I4); caxis([-1 3]); colorbar;
    title('I3-I4');
    hold on;
    contour(I1, 3, 'w', 'LineWidth', 1);
    %     % Superposition des pixels avec R² > seuil_R2
    ...
    subplot(3,3,9);
    imagesc(I4-I1); caxis([-1 3]); colorbar;
    title('I4-I1');
    ...
    % choisir stack
    image_Zi = imgs_Zpermute(2,:, :, :); % Si imgs_Z est déjà de taille (Nx, Ny, Nlambda), pas besoin de changer
    ...
    intensityprofile(image_Zi,wavenumber,2,10,10,70,79,3,3);
