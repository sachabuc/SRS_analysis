...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\spectres\campagne cocco\260114b\13-30-24_Z4';
...
%260114a Z0
wavelengths=[926.9, 930.5,928.5,927.8]; 
...
if contrast == true
    ...
    subplot(3,3,1);
    imagesc(I1); caxis([-1 20]); colorbar;
    title('calcite (I1)');
    
    subplot(3,3,2);
    imagesc(I3); caxis([-1 20]); colorbar;
    title('ACC H2O (I3) ');
    ...
    subplot(3,3,4);
    imagesc(I2); caxis([-1 20]); colorbar;
    title('fluo (I2)');
    ...
    subplot(3,3,8);
    imagesc((I3-I1)./(I3+I1)); caxis([-1 40]); colorbar;
    title('(I3-I1)./(I3+I1)');
    ...
    subplot(3,3,9);
    imagesc((I3-I1)./(I3+I1-2*I2)); caxis([-1 40]); colorbar;
    title('(I3-I1)./(I3+I1-2*I2)');

    [mask_calcite, mask_acc] = detect_calcite_acc_mistral(squeeze(imgs),wavenumber,4);
