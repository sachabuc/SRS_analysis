...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\spectres\campagne cocco\260114d\15-23-35_Z-1';
...
%260114a Z0
wavelengths=[920.5,917.8,961.5,952.1] ; 
...
%Contrast
    ...
    n4 = 4;
    % n5 = 6 ;
    I1 = squeeze(I_corr(:,:,n1)); % poly 1
    I2 = squeeze(I_corr(:,:,n2)); % poly 1 sup 
    I3 = squeeze(I_corr(:,:,n3)); % poly 2
    I4 = squeeze(I_corr(:,:,n4)); % poly 2 sup 
    ...
    subplot(2,3,2);
    imagesc(I2); caxis([-1 5]); colorbar;
    title('poly 1 sup (I2)');

    subplot(2,3,3);
    imagesc(I3); caxis([-1 5]); colorbar;
    title('poly 2 (I3)');

    subplot(2,3,4);
    imagesc(I2-I1); caxis([-1 5]); colorbar;
    title('poly 2 sup (I4)');

    subplot(2,3,5);
    imagesc(I1-I2); caxis([-1 5]); colorbar;
    title('(I1-I2)');

    subplot(2,3,6);
    imagesc(I3-I4); caxis([-1 5]); colorbar;
    title('I3-I4');
