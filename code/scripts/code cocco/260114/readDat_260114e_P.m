...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\spectres\campagne cocco\260114e';
...
%260114a Z0
wavelengths=[923.6,920.7,917.7,927.1]; 
...
if contrast == true
    ...
    I4 = I_corr(:,:,n4); % polyphosphate 1 borne inf 
    ...
    title('polyphosphate 1 borne inf (I4) ');

    subplot(3,3,5);
    imagesc(C21); caxis([-1 2]); colorbar;
    title('(I2-I1)./(I1+I2)');
    
    subplot(3,3,6);
    imagesc(C23); caxis([-0.5 1]); colorbar;
    title('(I2-I3)./(I2+I3)');

    subplot(3,3,7);
    imagesc(C24); caxis([-0.5 1]); colorbar;
    title('(I2-I4)./(I2+I4)');
