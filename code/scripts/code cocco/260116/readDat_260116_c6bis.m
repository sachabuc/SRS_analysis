...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\spectres\campagne cocco\260119\09-20-42_cell6bis';
...
if contrast == true
    ...
    subplot(3,3,1);
    imagesc(I1); caxis([-1 30]); colorbar;
    title('calcite (I1)');
    
    subplot(3,3,4);
    imagesc(I2); caxis([-1 15]); colorbar;
    title('fluo (I2) ');
    
    subplot(3,3,2);
    imagesc(I3); caxis([-1 15]); colorbar;
    title('ACC H2O (I3)');

    subplot(3,3,3);
    imagesc(I4); caxis([-1 15]); colorbar;
    title('ACChira (I4) ');

    subplot(3,3,5);
    imagesc(C352); caxis([-1 2]); colorbar;
    ...
    subplot(3,3,6);
    imagesc(C45); caxis([-1 2]); colorbar;
    title('(I4-I5)./(I5+I4)');
    
    subplot(3,3,8);
    imagesc(C34); caxis([-0.5 1]); colorbar;
    title('(I3-I4)./(I4+I3)');

    subplot(3,3,9);
    imagesc(C34_bin); caxis([-0.5 1]); colorbar;
    title('(I3-I4)./(I4+I3-2*I2) - binné');

    subplot(3,3,7);
    imagesc(I5); caxis([-1 15]); colorbar;
    title('ACC inf (I5)');
