...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\spectres\banque spectres SRS\13-32-40_ACC_ter';
...
if contrast == true
    ...
    subplot(3,3,5);
    imagesc(I2-I1);colorbar;
    title('I2-I1');
    
    subplot(3,3,6);
    imagesc(I3-I2);colorbar;
    title('I3-I2');
    hold on;
    contour(I1, 3, 'w', 'LineWidth', 1);
    hold off;
    ...
    subplot(3,3,9);
    imagesc((I3-I1)./(I1+I3-2*I2));  colorbar;
