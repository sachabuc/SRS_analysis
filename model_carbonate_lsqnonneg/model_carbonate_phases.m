...
%
%   [phase_model, wavenumber] = MODEL_CARBONATE_PHASES(tau_fwhm, use_ACC,
...
%   par tau_fwhm). La convolution de deux gaussiennes etant elle-meme une
...
%
%   ENTREES
%     tau_fwhm          : FWHM (ps) de la reponse instrumentale utilisee
%                          pour le modele principal (celui retourne dans
%                          phase_model). tau_fwhm <= 0 -> pas
...
if display_figures
    ...
    figCompareAnalyticalNumerical(phase_model, wavenumber, dw, sigma_inst, tau_fwhm);
