...
wavelengths = [927.2, 927.6, 928.0, 926.7, 926.5, 926.2, 928.3, 928.7, 929.2, 930.1, 925.7, 925.0, 924.5, 923.9, 930.4, 931.0, 920.1, 920.3, 919.6, 920.8, 961.5]; 
% 
...
%Contrast
    ...
    % choisir stack
    image_Zi = imgs_Zpermute(10,:, :, :); % Si imgs_Z est déjà de taille (Nx, Ny, Nlambda), pas besoin de changer
