...
wavelengths = [927.3, 926.7,927.6, 928.1, 928.6, 929.3, 930, 927.3, 925.8, 924, 920, 919.5, 920.7, 961.5]; 
% 
...
%Contrast
    ...
    image_Zj = imgs_Zpermute(10,:, :, :);
    
    [A_exp,tau_exp,Imean,Cst] = extract_fluo_cst(image_Zi, n2);
    [A_exp2,tau_exp2,Imean2,Cst2] = extract_fluo_cst(image_Zi, n2);
    % [A_exp3,tau_exp3,Imean3,Cst3] = extract_fluo_cst(imgs, n2);

    [A_expbis,tau_expbis,Imeanbis] = extract_fluo(image_Zi, n2);
    [A_expbis2,tau_expbis2,Imeanbis2] = extract_fluo(image_Zi, n2);
