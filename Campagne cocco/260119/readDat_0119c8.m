...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\spectres\campagne cocco\260119\11-07-32_cell8';
...
%260114a Z0
wavelengths=[927, 927, 930.7, 928.1, 928.6, 929.3] ; 
...
if contrast == true
    ...
    % Contraste binné
    C342_bin = (I3_bin - I4_bin) ./ (I3_bin + I4_bin - 2*I2_bin);
    C312_bin = (I3_bin - I1_bin) ./ (I3_bin + I1_bin - 2*I2_bin);
    C452_bin = (I4_bin - I5_bin) ./ (I4_bin + I5_bin - 2*I2_bin);
    C352_bin = (I3_bin - I5_bin) ./ (I3_bin + I5_bin - 2*I2_bin);
    ...
    subplot(3,3,4);
    imagesc(I2); caxis([-1 100]); colorbar;
    title('fluo (I2)');
    
    subplot(3,3,2);
    imagesc(I3); caxis([-1 100]); colorbar;
    title('ACC-H2O (I3)');
    
    subplot(3,3,3);
    imagesc(I4); caxis([-1 100]); colorbar;
    ...
    subplot(3,3,5);
    imagesc(C452_bin); caxis([-1 1]); colorbar;
    title('(I4-I5)./(I4+I5-2*I2) - bin');

    subplot(3,3,6);
    imagesc(C352_bin); caxis([-1 1]); colorbar;
    title('(I3-I5)./(I3+I5-2*I2) - bin');
    
    subplot(3,3,8);
    imagesc(C342_bin); caxis([-1 1]); colorbar;
    title('(I3-I4)./(I3+I4-2*I2) - bin');
    
    subplot(3,3,9);
    imagesc(C312_bin); caxis([-1 1]); colorbar;
    title('(I3-I1)./(I3+I1-2*I2) - bin');
