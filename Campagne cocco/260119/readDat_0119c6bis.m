...
if contrast == true
    ...
    subplot(3,3,6);
    imagesc(I3-I2); caxis([-1 10]); colorbar;
    title('I3-I2');

    subplot(3,3,5);
    imagesc(I4-I2); caxis([-1 10]); colorbar;
    title('I4-I2');
    ...
    subplot(3,3,7);
    imagesc(C42); caxis([-0.5 1]); colorbar;
    title('(I4-I2)./(I2+I4)');

    % subplot(3,3,7);
    % imagesc(C4); caxis([-1 1]); colorbar;
    % title('(I4-I5)./(I4+I5)');
    % 
    % subplot(3,3,8);
    % imagesc(C45_bin); caxis([-1 1]); colorbar;
    % title('(I4-I5)./(I4+I5) - bin');
