...
%Contrast
    ...
    I2 = squeeze(I_corr(n4,:,:)); % ACChira inf
    I3 = squeeze(I_corr(n5,:,:)); % inf ACC 
    % C=(I1-I2)./(I1+I2);
    % C1=(I1-I2)
    % C3=(I3-I2);
    % C4=(I4-I2);
    ...
    subplot(2,2,1);
    imagesc(I1); caxis([-1 10]); colorbar;
    title('calcite (I1)');
    ...
    subplot(2,2,2);
    imagesc(I2); caxis([0 0.7]); colorbar;
    title('ACChira inf 1 (I2)');
    ...
    % subplot(3,3,5);
    % imagesc((I3-I5)./(I3+I5-2*I2)); caxis([-0.5 1]); colorbar;
    % title('(I3-I5)./(I3+I5-2*I2)');

    % subplot(3,3,6);
    % imagesc((I4-I5)./(I4+I5-2*I2)); caxis([-0.5 1]); colorbar;
    % title('(I4-I5)./(I4+I5-2*I2)');

    subplot(2,2,3);
    imagesc(I3); caxis([-1 3]); colorbar;
    title('ACChira inf 2 (I3)');

    subplot(2,2,4);
    imagesc((I2-I1)./(I1+I2)); caxis([-1 0.5]); colorbar;
    title('(I2-I1)./(I2+I1)');

    % subplot(3,3,9);
    % imagesc((I3-I1)./(I1+I3-2*I2)); caxis([-0.5 1]); colorbar;
