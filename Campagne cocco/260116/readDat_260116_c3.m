...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\spectres\campagne cocco\260116\13-10-27_cell3';
...
%260114a Z0
wavelengths = [926.9, 930.5, 927.8, 928.5] ; 
...
if contrast == true
    ...
    if exist(filename_A, 'file') && exist(filename_tau, 'file') && ...
       exist(filename_C, 'file') && exist(filename_Imean, 'file') && exist(filename_R2, 'file')
        ...
        [A_map, tau_map, C_map, Imean_map, R2_map] = extract_map_fluo(imgsc);
    ...
    for i = 1:3
        ...
        % gauss = @(p,x) 1./(p(2)*sqrt(2*pi)) .* exp(-(x-p(1)).^2./(2*p(2)^2));
