...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\spectres\campagne cocco\260116\15-30-12_cell5';
...
%260114a Z0
wavelengths = [927, 930.5, 928, 928.6, 929.1]; 
...
if contrast == true
    ...
    subplot(3,3,1);
    imagesc(I1); caxis([-1 50]); colorbar;
    title('calcite (I1)');
    hold on;
    ...
    subplot(3,3,2);
    imagesc(I3); caxis([-5 20]); colorbar;
    title('ACC-H2O (I3)');
    hold on;
    contour(I1, 3, 'w', 'LineWidth', 1);
    hold off;
    ...
    subplot(3,3,3);
    imagesc(I4); caxis([-5 20]); colorbar;
    ...
    subplot(3,3,4);
    imagesc(I2); caxis([-5 20]); colorbar;
    title('fluo (I2)');
    hold on;
    contour(I1, 3, 'w', 'LineWidth', 1);
    hold off;
    ...
    subplot(3,3,5);
    imagesc(I2-I1); caxis([-2 3]); colorbar;
    title('I2-I1');
    hold on;
    contour(I1, 3, 'w', 'LineWidth', 1);
    hold off;
    ...
    subplot(3,3,6);
    imagesc(I3-I2); caxis([-2 3]); colorbar;
    title('I3-I2');
    hold on;
    contour(I1, 3, 'w', 'LineWidth', 1);
    hold off;
    ...
    subplot(3,3,7);
    imagesc(I5); caxis([-5 20]); colorbar;
    title('inf ACC (I5)');
    hold on;
    contour(I1, 3, 'w', 'LineWidth', 1);
    hold off;
    ...
    subplot(3,3,8);
    imagesc(I3-I1); caxis([-2 3]); colorbar;
    title('I3-I1');
    hold on;
    contour(I1, 3, 'w', 'LineWidth', 1);
    hold off;
    ...
    subplot(3,3,9);
    imagesc((I3-I1)./(I1+I3-2*I2)); caxis([-0.5 2]); colorbar;
    ...
    intensityprofile(imgs,wavenumber,2);
