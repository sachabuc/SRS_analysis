...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\spectres\campagne cocco\260116\10-18-17_cell1';
...
%260114a Z0
wavelengths = [927, 930.7, 928, 928.7, 929.4]; 
...
if contrast == true
    ...
    [A_exp,tau_exp,Imean,Cst] = extract_fluo_cst(imgs, n2,5,5,80,80,40,40);
...
%% Affichage images SRS fluo corrigé 
    ...
    % [ROI_sig_coord_corr,corr_Iprofile] = intensityprofile(imgs_fluo_corr,wavenumber,3,10,10,158,138,3,3); % ROI ACC
    [ROI_sig_coord_corrA,corr_IprofileA] = intensityprofile(imgs_fluo_corrA,wavenumber,3,10,10,158,138,3,3); % ROI ACC
    [ROI_sig_coord,Iprofile] = intensityprofile(imgs,wavenumber,3,10,10,158,138,3,3); % n_ACC,x_ROI_bckg,y_roi_bckg,x_ROI_signal,y_ROI_signal,w_ROI_signal,h_ROI_signal
