...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\spectres\campagne cocco\260116\10-48-34_cell2';
...
%260114a Z0
wavelengths = [927, 930.5, 927.8, 928.5, 929.4] ; 
...
%% contraste entre différentes composantes spectre
if contrast == true
    I_raw = squeeze(imgs);
    ...
    subplot(3,3,1);
    imagesc(I1); caxis([-30 70]); colorbar;
    title('calcite (I1)');
    hold on;
    ...
    subplot(3,3,2);
    imagesc(I3); caxis([-10 8]); colorbar;
    title('ACC-H2O (I3)');
    hold on;
    contour(I1, 3, 'w', 'LineWidth', 1);
    hold off;
    ...
    subplot(3,3,3);
    imagesc(I4); caxis([-10 8]); colorbar;
    ...
    subplot(3,3,4);
    imagesc(I2); caxis([-10 8]); colorbar;
    title('fluo (I2)');
    hold on;
    contour(I1, 3, 'w', 'LineWidth', 1);
    hold off;
    ...
    subplot(3,3,5);
    imagesc((I2-I1)); caxis([-10 8]); colorbar;
    title('I2-I1');
    hold on;
    contour(I1, 3, 'w', 'LineWidth', 1);
    hold off;
    ...
    subplot(3,3,6);
    imagesc((I3-I2)); caxis([-10 8]); colorbar;
    title('I3-I2');
    hold on;
    contour(I1, 3, 'w', 'LineWidth', 1);
    hold off;
    ...
    subplot(3,3,7);
    imagesc(I5); caxis([-10 8]); colorbar;
    title('inf ACC (I5)');
    hold on;
    contour(I1, 3, 'w', 'LineWidth', 1);
    hold off;
    ...
    subplot(3,3,8);
    imagesc(I3-I1); caxis([-10 8]); colorbar;
    title('I3-I1)');
    hold on;
    contour(I1, 3, 'w', 'LineWidth', 1);
    hold off;
    ...
    subplot(3,3,9);
    imagesc((I3-I1)./(I1+I3-2*I2)); caxis([-1 1]); colorbar;
    title('(I3-I1)./(I3+I1-2*I2)');
    hold on;
    contour(I1, 3, 'w', 'LineWidth', 1);
    hold off;

    % [A_exp,tau_exp,Imean] = extract_fluo(imgs, n2);
    % 
    % correctfluo_intensityprofile(imgs,wavenumber,n3,A_exp,tau_exp,Imean)

    [A_exp,tau_exp,Imean,Cst] = extract_fluo_cst(imgs, n2);
