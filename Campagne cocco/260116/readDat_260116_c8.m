...
if contrast == true
    ...
    subplot(3,3,1);
    imagesc(I1); caxis([-5 250]); colorbar;
    title('calcite (I1)');
    hold on;
    ...
    subplot(3,3,2);
    imagesc(I3); caxis([-5 100]); colorbar;
    title('ACC-H2O (I3)');
    hold on;
    contour(I1, 3, 'w', 'LineWidth', 1);
    hold off;
    ...
    subplot(3,3,3);
    imagesc(I4); caxis([-5 100]); colorbar;
    title('ACChira inf (I4)');
    
    subplot(3,3,4);
    imagesc(I2); caxis([-5 100]); colorbar;
    title('fluo (I2)');
    
    subplot(3,3,5);
    imagesc(I2-I1); caxis([-1 25]); colorbar;
    title('I2-I1');
    
    subplot(3,3,6);
    imagesc(I3-I2); caxis([-3 25]); colorbar;
    title('I3-I2');
    hold on;
    contour(I1, 3, 'w', 'LineWidth', 1);
    hold off;
    ...
    subplot(3,3,7);
    imagesc(I5); caxis([-5 100]); colorbar;
    title('inf ACC (I5)');
    
    subplot(3,3,8);
    imagesc((I3-I1)); caxis([-1 25]); colorbar;
    title('I3-I1');
    hold on;
    contour(I1, 3, 'w', 'LineWidth', 1);
    hold off;
    ...
    % PCA_ACC_calcite_classification(imgs, wavenumber)

    intensityprofile(imgs,[],4);
