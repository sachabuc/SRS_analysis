...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\spectres\campagne cocco\260114a\11-17-21_Z-2-5';
...
if contrast == true
    ...
    subplot(2,2,2);
    imagesc(I3); caxis([-1 10]); colorbar;
    title('ACC Chira (I3) ');
    
    subplot(2,2,3);
    imagesc(I2); caxis([-1 10]); colorbar;
    title('fluo (I2)');
