...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\spectres\campagne cocco\260114a\10-52-31_Z-5';
sub_dir  = '';
...
if contrast == true
    ...
    figure(102);
    subplot(2,2,1);
    imagesc(I1); caxis([-1 1]); colorbar;
    subplot(2,2,2);
    imagesc(I2); caxis([-1 1]); colorbar;
    subplot(2,2,3);
    imagesc(C); caxis([-1 1]); colorbar;
    subplot(2,2,4);
