function superpose_spectre_Ara_MHC(wavenumber_sorted, sp_sorted, tau_fwhm)
...
pic1     = lorentzienne(1.00, 1068.0, 3.2, wavenumber);
pic2     = lorentzienne(1.00, 1085.0, 3.2, wavenumber);
...
% Légende adaptative
if tau_fwhm > 0
    legend({'theoritical MHC + Aragonite', ...
            sprintf('theoriticals \\otimes instrumental response'), ...
            'Experimental measurements'}, ...
           'Location', 'northwest', 'FontSize', 11);
else
    legend({'theoritical MHC + Aragonite', 'Expérimental'}, ...
