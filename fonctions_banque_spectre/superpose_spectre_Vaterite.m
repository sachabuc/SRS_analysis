function superpose_spectre_Vaterite(wavenumber_sorted, sp_sorted, tau_fwhm)
...
pic2     = lorentzienne(0.15, 1081.0, 3.5, wavenumber);
...
if tau_fwhm > 0
    title(sprintf('Spectre SRS – Vatérite  |  instrumental response FWHM = %.1f cm^{-1}', tau_fwhm), ...
          'FontSize', 13);
else
...
% Légende adaptative
if tau_fwhm > 0
    legend({'theoritical vaterite (ref H. Dicko)', ...
            sprintf('theoritical vaterite \\otimes instrumental response'), ...
            'Experimental measurements'}, ...
           'Location', 'northwest', 'FontSize', 11);
else
    legend({'Vatérite (référence Dicko)', 'Expérimental'}, ...
