...
main_dir = 'C:\Users\sacha.bucourt\Documents\Data lab\spectres\banque spectres SRS\260225\14-04-17_CCHH'

sub_dir  = '';
sub_dir_save = [main_dir '/extracted_data/' sub_dir];

title_fig = 'CCHH no chirp';

wavelengths =[926.1,926.6,926.9,927.4,926.3,925.8,925.3,924.8,926.4]  ;
...
filepath = 'C:\Users\sacha.bucourt\Documents\Data lab\spectres raman spontanée\200226';
filename = 'vat_alons_bis_x100.l6s';

[w, I] = lire_spectre_raman(filepath, filename);
